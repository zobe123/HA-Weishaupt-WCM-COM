...
#    {"id": 274, "name": "Betriebsmodus", "type": "value"},
    ...
    {"id": 2586, "name": "Gemischte Außentemperatur", "type": "temperature"},
    {"id": 4, "name": "Zirkulationstemperatur", "type": "temperature"},
    {"id": 15, "name": "Soll Temp", "type": "temperature"},
    {"id": 1257, "name": "Soll Temp System", "type": "temperature"},
